                ...
                <div className=" bg-white p-5 rounded-lg relative space-y-3 shadow-lg">
                    ...
                    <div className=" flex justify-between items-center">
                        ...
                        <div className=" flex items-center text-xl">
                            <span className=" border p-3 rounded-lg hover:bg-green-500 hover:text-white text-green-500"><FaEdit /></span>
                            <span className=" border p-3 rounded-lg hover:bg-red-500 hover:text-white text-red-500 "><MdDelete /></span>
                        </div>
                    </div>
