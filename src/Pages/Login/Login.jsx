            ...
            <div className=" md:flex ">
                ...
                <div className="md:w-[70%] bg-gradient-to-r from-orange-200  to-gray-100 p-10 ">
                    <div className="space-y-10 lg:w-3/4 mx-auto">
                        <p className=" text-center font-bold text-3xl">Login your Time Doctor Account</p>
                        <p className=" text-center">your need an account? <Link to='/Register' className=" font-bold">Register</Link> </p>
                        ...
                        <form action="" onSubmit={handleSubmit(handelFormSubmit)} >
                            ...
                            <div>
                                <div className=" flex justify-center mt-6">
                                    <button className="btn  bg-purple-600 text-white hover:bg-purple-800 ">Login your account </button>
                                </div>
                            </div>
                        </form>
                    </div>
